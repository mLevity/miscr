...
export default function Settings() {
  ...
  return (
    <div className="page settings-page">
      ...
      <h1>Данные на устройстве</h1>
      <section className="content-panel">
        <h2>Локальная коллекция</h2>
        <p>
          Коллекция хранится в этом браузере. Для переноса на другое устройство
          или сохранения копии экспортируйте JSON.
        </p>
        <p>
          Состояние:{" "}
          {status === "ready"
